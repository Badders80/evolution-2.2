...
const articles: Article[] = [
  {
    ...
    excerpt: 'Discover what\'s new in Evolution 2.2 including a fresh design system and Auth0 integration.',
  },
  {
    slug: 'fractional-ownership-trends',
    title: 'The Rise of Fractional Horse Ownership',
    excerpt: 'How tokenisation is transforming the way people invest in thoroughbreds around the world.',
  },
];
